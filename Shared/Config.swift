...
struct Config {
    ...
    // Messages
    static let msgRequestContactsAccess = "This app needs to access your contacts.\n\nPlease launch your Settings app. You should see a list of apps, including this \"PhotoCaller\" app; tap it.\n\nYou should see a headline \"ALLOW PHOTOCALLER TO ACCESS\". You should see the \"Contacts\" slider choice. Enable it. Then relaunch this \"PhotoCaller\" app."
